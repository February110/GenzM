          ...
          <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
              ...
              <form>
                ...
                <div className="flex flex-wrap gap-4 xl:justify-between">
                  <div className="mb-4 flex md:mb-0">
                    ...
                    <span className="group mt-2 flex h-5 min-w-[20px] items-center justify-center rounded-sm bg-gray-100 peer-checked:bg-primary dark:bg-gray-700">
                      <svg
                    ...
                    >
                      Tôi đồng ý với chính sách hỗ trợ & bảo mật của hệ thống.
                    </label>
                  </div>

                  <button
                    aria-label="send message"
                    className="inline-flex items-center gap-2.5 rounded-full bg-black px-6 py-3 font-medium text-white hover:bg-black/90 dark:bg-btndark"
                  >
                    Gửi yêu cầu
            ...
            >
              ...
              <div className="5 mb-7">
                ...
                <p>
                  <a href="mailto:support@classroom.vn">anhtai1879@gmail.com</a>
                </p>
              </div>
