      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              subtitle: `Đồng bộ dữ liệu và hoạt động theo thời gian thực.`,
              description: `Hệ thống Classroom được tích hợp nhiều công nghệ hiện đại như WebRTC, SignalR, Cloud Storage và cơ sở dữ liệu bảo mật giúp việc giảng dạy và học tập luôn mượt mà, ổn định và nhanh chóng.`,
            }}
          />
          {/* <!-- Section Title End --> */}
        </div>
        ...
        <div className="pattern-dots pattern-blue-500 pattern-bg-white pattern-size-4 pattern-opacity-10 relative z-50 mx-auto mt-15 max-w-c-1154 px-4 md:px-8 xl:mt-20 xl:px-0">
          ...
          <div className="flex flex-wrap justify-around gap-y-10">
            ...
            <motion.div className="animate_top w-1/6"></motion.div>
